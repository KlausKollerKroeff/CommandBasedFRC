...
public class ClimberReleaseCmd extends Command {
   ...
   */
  public ClimberReleaseCmd(Climber climber, double setPositionClimberPID) {
  ...
  public void initialize() {
    SmartDashboard.putBoolean("Climber Releasing", true);
  }
  ...
  public void end(boolean interrupted) {
    SmartDashboard.putBoolean("Climber Releasing", false);
  }
